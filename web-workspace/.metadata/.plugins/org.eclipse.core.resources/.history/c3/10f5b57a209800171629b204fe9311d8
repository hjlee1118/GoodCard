...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		id="mainNav">
	<div class="container">
		<a class="navbar-brand" href="index.html">Good Card</a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link" href="${ pageContext.request.contextPath }/card/creditcard.do">신용카드</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="${ pageContext.request.contextPath }/card/checkcard.do">체크카드</a>
				</li>
				<c:choose>
			...
			<div class="col-lg-8 col-md-10 mx-auto">
				<div class="site-heading">
					...
					<span class="subheading">최적의 카드를 추천 해드립니다.</span> <br> <br>
						<a href="${ pageContext.request.contextPath }/recommend/poll.do" class="recommend_path_button"
						style="padding: 10px 10px">내게 맞는 카드 찾기 >></a>					
				</div>
			</div>
		</div>
	</div>
