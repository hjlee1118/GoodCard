...
public class MongoDBTest {
	/*
	 @Test public void getConnection() { String mongoIP = "13.124.174.15"; int
	 mongoPort = 27017; String dbName = "hana";
	 
	 //Connect to MongoDB MongoClient mongoClient = new MongoClient(new
	 ServerAddress(mongoIP, mongoPort));
	 
	 //View Database List List<String> databases =
	 mongoClient.getDatabaseNames();
	 
	 System.out.println("-----Database List-----"); int num = 1; for(String
	 dName : databases){ System.out.println(num + ". " + dName); num++; }
	 
	 System.out.println();
	 
	 //Connect Database and Show Collection List in Database DB db =
	 mongoClient.getDB(dbName); Set<String> collections =
	 db.getCollectionNames();
	 
	 System.out.println("Database : " + dbName); for(String colName :
