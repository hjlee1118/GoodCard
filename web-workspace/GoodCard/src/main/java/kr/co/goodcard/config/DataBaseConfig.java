...
/*	private static String DRIVER_NAME = "oracle.jdbc.driver.OracleDriver";
	...
	private static String URL = "jdbc:mysql://13.124.174.15:3306/hana";
	private static String USERNAME = "goodcard";
	private static String PASSWORD = "goodcard";
	...
	public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
		...
		Resource[] res = new PathMatchingResourcePatternResolver().getResources("classpath:config/sqlmap/oracle/*.xml");
